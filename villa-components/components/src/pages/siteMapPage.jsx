...
/**
 * SiteMapPage component - Renders a site map with links to all content pages
 * @param {Object} props - SiteMapPage props
 ...
 * @returns {JSX.Element} The SiteMapPage component
 */
